...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Editar',
        href: `/despesas/${props.despesa.id}/edit`,
    },
];
...
const form = useForm({
    ...
    categoria: props.despesa.categoria,
    status: props.despesa.status,
    data_pagamento: props.despesa.data_pagamento || '',
    data_vencimento: props.despesa.data_vencimento,
    recorrente: props.despesa.recorrente,
    observacoes: props.despesa.observacoes || '',
    responsible_user_id: props.despesa.responsible_user_id?.toString() || '',
});
...
const submit = () => {
    form.put(`/despesas/${props.despesa.id}`, {
        onSuccess: () => {
                        ...
                        <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="flex justify-end space-x-4">
                                <Button
                                    type="button"
                                    variant="outline"
                                    @click="$inertia.visit(`/despesas/${despesa.id}`)"
                                >
                                    Cancelar
                                </Button>
                                <Button
